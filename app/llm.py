...
# El orden importa: gana la primera categoría que matchea. Las específicas van
# primero. (No se auto-asignan "Gastos Delfi/Lu/Padres" ni "Colegio" porque no
# se deducen del nombre del comercio; ésas las elige el usuario en la revisión.)
_CAT_KEYWORDS = [
    ("Colegio", r"COLEGIO|ESCUELA|INSTITUTO EDUC|JARDIN DE INFANTES|PREESCOLAR|CUOTA COLEGIO"),
    ("Delivery", r"PEDIDOSYA|PEDIDOS YA|RAPPI|GLOVO|UBER\s?EATS|UBEREATS|MERPAGO\*?PEDIDOS|"
                 r"MOSTAZA DELIVERY|DELIVERY"),
    ("Compra de Super", r"COTO|CARREFOUR|JUMBO|\bDIA\b|DISCO|\bVEA\b|LA ANONIMA|LA ANÓNIMA|"
                        r"CHANGOMAS|CHANGO MAS|WALMART|MAKRO|VITAL|MAXICONSUMO|"
                        r"SUPERMERCADO|AUTOSERVICIO|LA REINA|TOLEDO SA"),
    ("Gastos Autos", r"YPF|SHELL|AXION|PUMA ENERGY|GNC|ESTACION DE SERVICIO|AUTOPISTA|TELEPEAJE|"
                     r"PEAJE|AUBASA|AUSA|CAMINOS DEL|CVSA|VTV|ESTACIONAMIENTO|PARKING|"
                     r"LUBRICENTRO|GOMERIA|NEUMATIC|TALLER|REPUESTOS|AUTOPARTES|LAVADERO"),
    ("Gastos Viajes", r"AEROLINEAS|LATAM|FLYBONDI|JETSMART|AMERICAN AIRL|COPA AIR|IBERIA|"
                      r"AVIS|HERTZ|LOCALIZA|RENT.?A.?CAR|BOOKING|AIRBNB|DESPEGAR|ALMUNDO|"
                      r"TRIVAGO|EXPEDIA|HOTEL|HOSTEL|RESORT|CABAÑA|DUTY FREE"),
    ("Ropa", r"ZARA|H\s?&\s?M|\bHYM\b|UNIQLO|RENNER|KEVINGSTON|PORTSAID|AKIABARA|PRUNE|"
             r"MIMO|CHEEKY|GRISINO|YAGMOUR|RAPSODIA|WANAMA|LEVIS|ADIDAS|NIKE|TOPPER|"
             r"DEXTER|SPORTLINE|STOCK CENTER|GRIMOLDI|VITAMINA|47 STREET|INDUMENTAR|CALZAD"),
    ("Regalos", r"JUGUETER|JUGUETES|FLORERIA|FLORER[ií]a|REGALER|LIBRERIA EL|DISQUERIA"),
    ("Suscripciones", r"NETFLIX|SPOTIFY|DISNEY|HBO|MAX\b|PARAMOUNT|PRIME VIDEO|AMAZON PRIME|"
                      r"YOUTUBE|APPLE\.COM|APPLE COM|GOOGLE\s?\*|ITUNES|PLAYSTATION|"
                      r"XBOX|NINTENDO|CANVA|NOTION|CHATGPT|OPENAI|DROPBOX|MERCADO LIBRE\+|"
                      r"MELI\+|CLARO VIDEO|\bFLOW\b|PARAMOUNT"),
    ("Transporte", r"SUBE|MERPAGO\*?SUBE|UBER|CABIFY|DIDI|\bBEAT\b|REMIS|TAXI|TREN|SUBTE"),
    ("Servicios", r"TELECENTRO|FIBERTEL|CABLEVISION|CABLEVISIÓN|MOVISTAR|CLARO|PERSONAL|TUENTI|"
                  ...
                  r"PREVENCION|EXPENSAS|CONSORCIO|PAGOS360|RAPIPAGO|PAGO FACIL|"
                  r"PAGOFACIL|BAPRO|PROVINCIA NET"),
    ("Salud", r"FARMACIA|FARMACITY|FARMACIAS|DR AHORRO|DEL DR|PHARMACY|\bCVS\b|HOSPITAL|SANATORIO|"
              r"CLINICA|CLÍNICA|LABORATOR|DENTAL|ODONTO|OPTICA|ÓPTICA|OSDE|SWISS MEDICAL|"
              r"MEDICUS|GALENO|OMINT|MEDIFE|HOMEOPAT"),
    ("Hogar", r"ARREDO|\bEASY\b|SODIMAC|SODIMCO|FALABELLA|MERPAGO\*?(?:DILUCE|LAMAYOR)|"
              r"BAZAR|FERRETER|PINTURER|SANITARIOS|MUEBLES|"
              r"DECO|BLANQUER|LA CARDEUSE|SIMMONS|PIERO|MERCADO LIBRE|MERCADOLIBRE"),
    ("Ocio", r"CINE|CINEMA|HOYTS|CINEMARK|SHOWCASE|TEATRO|GARBARINO|FRAVEGA|"
             r"MUSIMUNDO|CLUB|GIMNASIO|\bGYM\b|SPORTCLUB|MEGATLON|PADEL|"
             r"CANCHA|BOWLING|RESTO|RESTAURANT|MC DONALD|MCDONALD|BURGER|STARBUCKS|"
             r"\bCAFE\b|\bBAR\b|PARRILLA|HELAD|KANSAS|KENTUCKY"),
    ("Alimentos", r"ALMACEN|VERDULER|CARNICER|PANADER|KIOSCO|DIETETICA|FIAMBRER|PESCADER"),
]
